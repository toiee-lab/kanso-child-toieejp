	...
	<div class="uk-section-default uk-text-center">
		<div class="uk-section uk-light uk-background-cover" style="background-image: url(<?php echo $fields['bg_image']; ?>)">
			<div class="uk-container">
				...
				<p class="uk-text-bold" style="text-shadow:0px 0px 3px #000000;color:<?php echo $fields['font_color']; ?>"><span uk-icon="lifesaver"></span> ITに関するサポートを随時受け付けております。お気軽に、ご相談ください</p>
